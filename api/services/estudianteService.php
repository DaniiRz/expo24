    ...
    if (isset($_SESSION['idAdministrador'])) {
        ...
        switch ($_GET['action']) {
            ...
            case 'createRow':
                ...
                if (
                    !$alumno->setCarnet($_POST['carnetAlumno']) or
                    !$alumno->setNombre($_POST['nombreAlumno']) or
                    !$alumno->setCorreo($_POST['correoAlumno']) or
                    !$alumno->setClave($_POST['claveAlumno'])
                ) {
                    $result['error'] = $alumno->getDataError();
                } elseif ($_POST['claveAlumno'] != $_POST['confirmarClave']) {
            ...
            case 'updateRow':
                ...
                if (
                    ...
                    !$alumno->setCarnet($_POST['carnetAlumno']) or
                    !$alumno->setNombre($_POST['nombreAlumno']) or
                    !$alumno->setCorreo($_POST['correoAlumno'])
                ) {
                    $result['error'] = $alumno->getDataError();
            ...
            case 'deleteRow':
                ...
                } elseif (!$alumno->setId($_POST['idAlumno'])) {
                    $result['error'] = $alumno->getDataError();
                ...
                break;
            case 'getUser':
                if (isset($_SESSION['correoAlumno'])) {
                    $result['status'] = 1;
                    $result['username'] = $_SESSION['correoAlumno'];
                } else {
