...
const SAVE_FORM = document.getElementById('saveForm'),
    idAdministrador = document.getElementById('idAdministrador'),
...
SAVE_FORM.addEventListener('submit', async (event) => {
    ...
    (idAdministrador.value) ? action = 'updateRow' : action = 'createRow';
    // Constante tipo objeto con los datos del formulario.
...
const openCreate = () => {
    ...
    nombreAdministrador.disabled = false;
    correoAdministrador.disabled = false;
...
const openUpdate = async (id) => {
    ...
    if (DATA.status) {
        ...
        nombreAdministrador.disabled = true;
        correoAdministrador.disabled = true;
        // Se inicializan los campos con los datos.
        const ROW = DATA.dataset;
        idAdministrador.value = ROW.id_empleado;
        nombreAdministrador.value = ROW.nombre_empleado;
        correoAdministrador.value = ROW.apellido_empleado;
    } else {
        sweetAlert(2, DATA.error, false);
    }
}
